...
button_edytuj_obiekt.grid(row=1, column=1)
...
button_dodaj_obiekt=Button(ramka_mapa, text="Dodaj obiekt")
...
label_szczegoly_obiektow=Label(ramka_szczegoly_obiektow, text="Imię:")
label_szczegoly_obiektow.grid(row=1, column=0)
label_szczegoly_name_wartosc=Label(ramka_szczegoly_obiektow, text="....")
label_szczegoly_name_wartosc.grid(row=2, column=0)
...
label_posts_surname=Label(ramka_szczegoly_obiektow, text="Posty:")
label_posts_surname.grid(row=1, column=6)
label_posts_surname_wartosc=Label(ramka_szczegoly_obiektow, text="....")
label_posts_surname_wartosc.grid(row=1, column=7)
